...
1. [Node.js][]: We use Node to run a development web server and build the project.
   ...
   (Before of compiler copy in directory examHipster/node_modules/ the packagess Node .Its missing in the project)
...
To build the final jar and optimize the A08 application for production, run:
